Feature: Interact with formulas
  ...
  Scenario: Install a formula with additional software roots
    When I successfully run `smithy formula install -a /tmp/othersw1,/tmp/othersw2 zlib/1.2/fullpath`
    # Then show me the files
    Then the stdout should contain "==> ./configure --prefix=/tmp/swsmithy/x86/zlib/1.2/fullpath"
    Then the stdout should contain "==> ./configure --prefix=/tmp/othersw1/x86/zlib/1.2/fullpath"
    Then the stdout should contain "==> ./configure --prefix=/tmp/othersw2/x86/zlib/1.2/fullpath"
    Then the stdout should contain "==> make"
    Then the stdout should contain "==> make install"
    Then the stdout should contain "==> SUCCESS /tmp/swsmithy/x86/zlib/1.2/fullpath"
    Then the stdout should contain "==> SUCCESS /tmp/othersw1/x86/zlib/1.2/fullpath"
    Then the stdout should contain "==> SUCCESS /tmp/othersw2/x86/zlib/1.2/fullpath"
    And a directory named "/tmp/swsmithy/x86/zlib/1.2/fullpath" should exist
    And a directory named "/tmp/othersw1/x86/zlib/1.2/fullpath" should exist
    And a directory named "/tmp/othersw2/x86/zlib/1.2/fullpath" should exist
    And a directory named "/tmp/swsmithy/x86/zlib/1.2/fullpath/source" should exist
    And a file named "/tmp/swsmithy/x86/zlib/1.2/fullpath/source/configure" should exist
    And a directory named "/tmp/swsmithy/x86/zlib/1.2/fullpath/lib" should exist
    And a file named "/tmp/swsmithy/x86/zlib/1.2/fullpath/lib/libz.a" should exist
    And a file named "/tmp/othersw1/x86/zlib/1.2/fullpath/lib/libz.a" should exist
    And a file named "/tmp/othersw2/x86/zlib/1.2/fullpath/lib/libz.a" should exist
