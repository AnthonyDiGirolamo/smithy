Feature: Add new software builds
  ...
  Scenario: Add a new software build
    ...
    And a file named "/tmp/swsmithy/x86/git/1.6/build1/rebuild" should have a group name of "staff"
  ...
  Scenario: Add a new software build with a source tarball
    ...
    And a file named "/tmp/swsmithy/x86/zlib/1.2.6/build1/source/configure" should have a group name of "staff"
  ...
  Scenario: Add a new software build with disabled group permissions
    ...
    And a file named "/tmp/swsmithy/x86/zlib/1.2.6/build2/source/configure" should have a group name of "staff"
