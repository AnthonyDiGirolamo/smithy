== smithy - Smithy will help you build, test, and distribute software with ease.
...
==== Command: <tt>module|modulefile  create|use|deploy NAME</tt>
...
Provide a source tarball to unpack (optional)
