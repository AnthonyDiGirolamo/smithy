...
[<tt>--config-file=FILE</tt>] Alternate config file, also set by $SMITHY_CONFIG
...
[<tt>--prgenv-prefix=NAME</tt>] The prefix of programming environments for this machine
...
[<tt>publish</tt>] Publish packages to web
[<tt>repair</tt>] Repair a package
[<tt>search</tt>] Search currently installed software
[<tt>show</tt>] Display internal smithy values
[<tt>test</tt>] Test software
...
[<tt>--disable-log</tt>] Disable logging
[<tt>-f, --force</tt>] Ignore .lock file and run anyway
[<tt>--log-name=FILE</tt>] Build log file name located within the software prefix. <i>( default: <tt>build.log</tt>)</i>
[<tt>-n, --dry-run</tt>] See what scripts will be run without running them
[<tt>-s, --suppress-stdout</tt>] Suppress messages from STDOUT.
=== <tt>edit build|test|env|modulefile NAME</tt>
...
[<tt>-s, --split</tt>] Split editing window with requested file and the environment (remodule) file
=== <tt>help [command]</tt>
...
=== <tt>module create|use|deploy NAME</tt>

Manage modulefiles for a package

*Aliases*
* <tt><b>modulefile</b></tt>
...
[<tt>--disable-log</tt>] Disable logging
[<tt>-f, --force</tt>] Ignore .lock file and run anyway
[<tt>--log-name=FILE</tt>] Test log file name located within the software prefix. <i>( default: <tt>test.log</tt>)</i>
[<tt>-n, --dry-run</tt>] See what scripts will be run without running them
[<tt>-s, --suppress-stdout</tt>] Suppress messages from STDOUT.
